...
export const INITIAL_SQUAD: TeamMember[] = [
  {
    ...
    role: 'Founder',
    currentStatus: 'Intern-Software Engineering- SLT BSc in Computer Science (UG)',
  ...
  },
  {
    ...
    role: 'Co-Founder',
    currentStatus: 'Intern-Quality Assurance-DreamTrillians BSc in Computer Science (UG)',
